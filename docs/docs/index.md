...
The purpose of Kentuckiana Mesh is to expand coverage in our area and build out the network to make it more usable. We currently have a number of nodes located in downtown Louisville and Southern Indiana and on top of other buildings out in the suburbs. We are always looking to expand our coverage and rely on ourselves and others who can get nodes in high up places to join us in building our off-grid communications network.
...
1. Join [our Discord](https://discord.gg/eqZzwXfFn9) to get to know us
...
5. Read the [getting started](https://kentuckianamesh.org/getting-started) page for more information
